...
# =========================================
# cpdp_ocr/6a_structural_parsing/src/arrest-report-section-by-position.R
...
parser$add_argument("--sections",
                    default = "hand/arrest-report-sections.yaml")
...
out <- arrest_report_sections %>%
    select(pdf_id, page_num, section_name, top = lab_top, bottom = lab_bottom) %>%
    filter(!str_detect(section_name, "UNKNOWN"))
